(defpackage combray/tests
  ...
  (:import-from :combray/combinators :pchar :pmany :pchoice :ptag :poptional :pstring :pnum :pbool :psym :pwithparens :preplacetag :ptagd :pmanywords :pwhitespace :pcharexcept :pstr)
  (:local-nicknames
